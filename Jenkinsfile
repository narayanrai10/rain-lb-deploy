pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/narayanrai10/rain-lb-deploy'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('rain-225')   // <---- Change this to match your kubernetes cluster credentials
    }
